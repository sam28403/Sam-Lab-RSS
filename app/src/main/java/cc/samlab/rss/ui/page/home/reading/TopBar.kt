...
import cc.samlab.rss.infrastructure.preference.ReadingPageTonalElevationPreference
import cc.samlab.rss.ui.component.base.FeedbackIconButton
import cc.samlab.rss.ui.page.adaptive.NavigationAction

private val sizeSpec = spring<androidx.compose.ui.unit.IntSize>(stiffness = 700f)
...
fun TopBar(
    ...
    val isOutlined = LocalReadingPageTonalElevation.current == ReadingPageTonalElevationPreference.Outlined
