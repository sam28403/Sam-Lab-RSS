package cc.samlab.rss.domain.model.article
 ...
 *
 * @see cc.samlab.rss.ui.page.home.flow.ArticleList
 */
sealed class ArticleFlowItem {
     ...
     * The [Article] item.
     *
     * @see cc.samlab.rss.ui.page.home.flow.ArticleItem
     */
     ...
     *
     * @see cc.samlab.rss.ui.page.home.flow.StickyHeader
     */
